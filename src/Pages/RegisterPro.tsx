...
function RegisterPagePro() {
  ...
  const handleSubmit = (event: React.FormEvent<HTMLFormElement>): void => {
    ...
    axios.post(import.meta.env.VITE_URL + '/professional/register', {
  ...
  return (
    <div className="LoginPage" style={{ background: "#FFFFFF", width: "100%", height: "100%" }}>
      ...
      <Card
        ...
        left="39vw"
      >
        <img src="../../public/ExadermaPro.svg" alt="logo" style={{ width: "13vw", height: "10vw", marginLeft: "auto", marginRight: "auto", display: "block" }} />
